...
for ciudad_idx, ciudad in enumerate(temperaturas):
    for semana_idx, semana in enumerate(ciudad):
        ...
        promedio_celsious = (promedio - 32) * 5/9
        print(f"Promedio de temperaturas en {ciudades[ciudad_idx]}, Semana {semana_idx + 1}: {promedio_celsious:.2f} grados")
        def calcular_promedio_temperaturas(datos):
            ...
            parammetros:
            datos:(dict): Diccionario con el formato {"ciudad":[temp_semana1, temp_semana2, ...]}

            retorna:
            dic: Diccionaro con el promedio de temperatura por ciudad.
            """
            ...
            def calcular_promedio_temperaturas(datos):
                ...
                return promedios  # <-- debe estar alineado con "for", NO con "def"
        ...
        int = calcular_promedio_temperaturas(datos)
